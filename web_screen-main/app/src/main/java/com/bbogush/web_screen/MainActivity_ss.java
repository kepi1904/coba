...
public class MainActivity_ss extends AppCompatActivity {
    private static final String TAG = MainActivity_ss.class.getSimpleName();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(MainActivity_ss.this, SettingsActivity.class);
